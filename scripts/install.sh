...
echo "Install required basic packages via apt"
sudo apt update
sudo apt install git tmux python-is-python3 python3 python3-dev python3-pip -y
echo "Install required bluetooth packages via apt"
sudo apt install bluez bluez-tools bluez-firmware python3-bluez -y
